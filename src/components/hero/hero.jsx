  ...
  return (
    <>
      <div
        ...
        style={{
          background: 'radial-gradient(rgb(2, 21, 48) 1%, rgb(0, 0, 0))',
        }}
      >
        {/* outermost flex-item-1 */}
        <div
          className={`border-0 border-green-600 w-full md:w-1/2 order-1 md:order-2`}
        >
          <motion.div
            id="heading"
          ...
          >
            Welcome to The
            <span style={{ color: 'rgb(164, 253, 0)' }}> Astronomy Club</span>
          ...
          >
            The Astronomy Club at IIT Indore fosters a passion for the cosmos
            through stargazing sessions, workshops, and educational talks. We
            provide a platform for students to explore celestial phenomena,
            engage in astrophotography, and collaborate on research projects,
            promoting a deeper understanding of the universe and its wonders.
          </motion.div>

          <motion.div
            className=" text-xl font-bold mx-[5vh] my-[5vh]"
            variants={screen.width >= 1000 ? left : right}
            animate={control}
            initial="hidden"
            whileInView="visible"
            style={{
