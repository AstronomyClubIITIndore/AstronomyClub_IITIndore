...
function News() {
  return (
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossOrigin="anonymous"/>
      ...
      <Navbar/>
      <div className="News-encloser2"> <div className="News-heading">Latest News about Astronomy...</div></div>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://www.astronomy.com/science/meteorite-strikes-create-the-moons-atmosphere/"><h5 className="card-title">Meteorite Impacts and the Moon's Atmosphere</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://phys.org/news/2024-07-webb-captures-staggering-quasar-galaxy.html"><h5 className="card-title">James Webb Space Telescope Captures Quasar-Galaxy Merger</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://news.mit.edu/2024/astronomers-spot-highly-eccentric-planet-becoming-hot-jupiter-0717#:~:text=The%20new%20planet%2C%20which%20astronomers,in%20a%20narrow%2C%20elliptical%20circuit."> <h5 className="card-title">Discovery of a Highly Eccentric Planet</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://www.space.com/james-webb-space-telescope-two-oldest-most-distant-galaxies"><h5 className="card-title">Most Distant Galaxy Found Using JWST</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://physics.mit.edu/news/mit-astronomers-observe-elusive-stellar-light-surrounding-ancient-quasars/"><h5 className="card-title">Light from Ancient Quasars</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://www.anu.edu.au/news/all-news/breakthrough-in-understanding-mysterious-gamma-ray-signal"><h5 className="card-title">Gamma Ray Breakthrough</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://www.bbc.com/news/science-environment-49648746"><h5 className="card-title">First-Ever Water Detected on a Rocky Exoplanet</h5></a>
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        <a href="https://www.space.com/28423-cosmic-inflation-signal-space-dust.html#:~:text=In%20the%20cosmic%20inflation%20announcement,about%2013.8%20billion%20years%20ago."><h5 className="card-title">Unveiling the Secrets of Cosmic Inflation</h5></a>
